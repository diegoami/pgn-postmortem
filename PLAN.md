...
The owner decided on 2026-09-25 that F-8 to F-11 come before F-1.3. Each gets its iteration number when it is shaped, and F-1.3 and F-1.4 then move after them. F-11 was then parked by the owner (2026-09-25), so after F-10 the next is F-1.3, once the first release (v0.1.0) is tagged.
